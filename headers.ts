...
/**
 * Create an object representation of http request headers from a raw http request
 * Largely ported from https://github.com/watson/http-headers/blob/master/index.js
 * @param {string} request a complete http request string
 * @return {HttpHeaders}
 */
export function parseHeaders(request:string):HttpHeaders {
  var headers = {}
  var next = nextLine(request)
  var line = next()
